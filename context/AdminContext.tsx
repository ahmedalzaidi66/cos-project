...
export const PERMISSION_ROUTES: Record<string, string> = {
  ...
  manage_analytics:      '/admin/analytics',
  ...
  manage_shipping:       '/admin/shipping',
  manage_sections:       '/admin/sections',
  manage_cms:            '/admin/content',
  manage_about:          '/admin/about',
...
export const ROUTE_PERMISSION: Record<string, string> = {
  ...
  '/admin/sections':    'manage_sections',
  '/admin/content':     'manage_cms',
  '/admin/about':       'manage_about',
  '/admin/builder':     'manage_cms_builder',
  '/admin/layout':      'manage_layout',
  '/admin/sizes':       'manage_theme',
...
export const EMPLOYEE_DEFAULT_ROUTES: { permission: string; route: string }[] = [
  ...
  { permission: 'manage_analytics',     route: '/admin/analytics' },
  { permission: 'manage_products',      route: '/admin/products' },
  { permission: 'manage_categories',    route: '/admin/categories' },
  { permission: 'manage_orders',        route: '/admin/orders' },
  { permission: 'manage_customers',     route: '/admin/customers' },
  { permission: 'manage_loyalty',       route: '/admin/loyalty' },
  { permission: 'manage_notifications', route: '/admin/notifications' },
  ...
  { permission: 'manage_shipping',      route: '/admin/shipping' },
  { permission: 'manage_sections',      route: '/admin/sections' },
  { permission: 'manage_cms',           route: '/admin/content' },
  { permission: 'manage_about',         route: '/admin/about' },
  { permission: 'manage_cms_builder',   route: '/admin/builder' },
  { permission: 'manage_layout',        route: '/admin/layout' },
  { permission: 'manage_theme',         route: '/admin/sizes' },
  { permission: 'manage_settings',      route: '/admin/settings' },
  { permission: 'view_audit_logs',      route: '/admin/audit-logs' },
  { permission: 'manage_campaigns',     route: '/admin/campaigns' },
];
...
const ALL_PERMISSIONS = [
  'view_dashboard', 'manage_analytics', 'manage_products', 'manage_categories',
  'manage_orders', 'manage_customers', 'manage_loyalty', 'manage_notifications',
  'manage_employees', 'manage_reviews', 'manage_coupons', 'manage_shipping',
  'manage_sections', 'manage_cms', 'manage_about', 'manage_cms_builder',
  'manage_layout', 'manage_theme', 'manage_settings',
  'manage_permissions', 'view_audit_logs', 'manage_campaigns',
];
