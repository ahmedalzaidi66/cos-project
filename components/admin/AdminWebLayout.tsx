...
const NAV_ITEMS = [
  ...
  { key: 'analytics',       icon: BarChart3,       route: '/admin/analytics',     permission: 'manage_analytics' },
  { key: 'products',        icon: Package,         route: '/admin/products',      permission: 'manage_products' },
  { key: 'categories',      icon: Layers2,         route: '/admin/categories',    permission: 'manage_categories' },
  ...
  { key: 'loyaltyAdmin',    icon: Coins,           route: '/admin/loyalty',       permission: 'manage_loyalty' },
  { key: 'notifications',   icon: Bell,            route: '/admin/notifications', permission: 'manage_notifications' },
  ...
  { key: 'shipping',        icon: Truck,           route: '/admin/shipping',      permission: 'manage_shipping' },
  { key: 'homeSections',    icon: LayoutList,      route: '/admin/sections',      permission: 'manage_sections' },
  { key: 'content',         icon: FileEdit,        route: '/admin/content',       permission: 'manage_cms' },
  { key: 'adminAbout',      icon: Info,            route: '/admin/about',         permission: 'manage_about' },
  { key: 'pageBuilder',     icon: Layers,          route: '/admin/builder',       permission: 'manage_cms_builder' },
  { key: 'layoutSpacing',   icon: LayoutGrid,      route: '/admin/layout',        permission: 'manage_layout' },
  { key: 'uiSizes',         icon: Maximize2,       route: '/admin/sizes',         permission: 'manage_theme' },
